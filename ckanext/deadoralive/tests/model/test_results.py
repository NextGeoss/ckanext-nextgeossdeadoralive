...
class TestGetResourcesToCheck(object):
    ...
    def test_with_5_new_resources_and_request_10(self):
        ...
        resources_to_check = results.get_resources_to_check(10,orgs)
    ...
    def test_with_10_new_resources_and_request_5(self):
        ...
        factories.Resource()['id']
        orgs = config.organization_to_filter
        resources_to_check = results.get_resources_to_check(5,orgs)
    ...
    def test_that_it_does_return_resources_with_expired_pending_checks(self):
        ...
        results._make_pending([resource_1, resource_2, resource_3, resource_4, resource_5],five_hours_ago)
        orgs = config.organization_to_filter
        resources_to_check = results.get_resources_to_check(10,orgs)
    ...
    def test_custom_shorter_since(self):
        ...
        orgs = config.organization_to_filter
        results_ = results.get_resources_to_check(10,orgs, since=datetime.timedelta(hours=5))
    ...
    def test_custom_longer_since(self):
        ...
        orgs = config.organization_to_filter
        results_ = results.get_resources_to_check(10, orgs, since=datetime.timedelta(hours=48))
    ...
    def test_custom_shorter_pending_since(self):
        ...
        orgs = config.organization_to_filter
        results_ = results.get_resources_to_check(10, orgs, pending_since=datetime.timedelta(hours=0.5))
    ...
    def test_custom_longer_pending_since(self):
        ...
        orgs = config.organization_to_filter
        results_ = results.get_resources_to_check(10, orgs, pending_since=datetime.timedelta(hours=4))
