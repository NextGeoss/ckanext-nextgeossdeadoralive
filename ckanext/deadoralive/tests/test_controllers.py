...
class TestBrokenLinksController(custom_helpers.FunctionalTestBaseClass):
    ...
    def test_broken_links_by_organization_with_unicode(self):
        ...
        dataset = custom_factories.Dataset(owner_org=org["id"],title=u"Test Dätaßet")
        resource = custom_factories.Resource(package_id=dataset["id"],name=u"Test Rëßource",url=u"http://bröken_link")
